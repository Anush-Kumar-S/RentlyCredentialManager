...
class CredentialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credential" do
    assert_difference("Credential.count") do
      post credentials_url, params: { credential: { created_by: @credential.created_by, login_id: @credential.login_id, login_password: @credential.login_password, name: @credential.name, updated_by: @credential.updated_by } }
    end
  ...
  test "should update credential" do
    patch credential_url(@credential), params: { credential: { created_by: @credential.created_by, login_id: @credential.login_id, login_password: @credential.login_password, name: @credential.name, updated_by: @credential.updated_by } }
